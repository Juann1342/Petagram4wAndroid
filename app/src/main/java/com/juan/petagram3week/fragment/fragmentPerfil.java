...
public class fragmentPerfil extends Fragment {
    ...
    public void inicializarListaMascotas(){
        ...
        masc.add(new Mascota("Petaco", R.drawable.petp1,"5"));
        masc.add(new Mascota("Petaco",R.drawable.petp2,"2"));
        masc.add(new Mascota("Petaco",R.drawable.petp3,"3"));
        masc.add(new Mascota("Petaco",R.drawable.pet5,"4"));
        masc.add(new Mascota("Petaco",R.drawable.petp4,"3"));
        masc.add(new Mascota("Petaco",R.drawable.pet2,"4"));
